...
echo "=========================================="
echo "🚀 Quant V16.0.0 - 终极大满贯开源同步向导"
echo "=========================================="
...
git commit -m "🚀 Release V16.0.0: Fixed NoneType math crash on ST/Suspended stocks & K-Line fix"
git branch -M main

git remote remove origin 2>/dev/null
git remote add origin "https://${GITHUB_USER}:${CLEAN_TOKEN}@github.com/xiasummer740/quant.git"

echo "[INFO] 正在发射终极满血版代码到 GitHub..."
git push -u origin main -f

echo "=========================================="
echo "✅ 同步成功！包含全息K线图的满血版本已开源！"
echo "=========================================="
