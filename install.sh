#!/bin/bash
echo "=========================================="
echo "🚀 欢迎使用 Quant Global AI Platform V4.1 一键安装向导"
echo "=========================================="
...
echo ""
echo "    location /api/ {"
echo "        proxy_pass http://127.0.0.0:8000;"
...
echo "=========================================="
echo "🔐 初始系统登录密码为: admin123"
echo "⚠️  (登入系统后请务必在底部的【系统配置】中修改密码)"
echo "=========================================="
